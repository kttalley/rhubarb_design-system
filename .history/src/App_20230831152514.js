...
import { color } from './Rhubarb/Utils.js';
import {
  GlobalStyle,
  Btn,
  Modal,
    ...
    return (
      <div>
        ...
        <DocsSection>
          ...
          <Icon name="pin" color={color.pink} size={100} />
        <Icon name="add" color={color.white} size={100} />
        <Icon name="cancel" color={color.white} size={100} />
      </DocsSection>
      <DocsSection>
          <h4>Button sizes</h4>
